...
zombie_image = pygame.image.load('zombie3.png')  # Tải hình ảnh zombie từ file PNG
zombie_image = pygame.transform.scale(zombie_image, (CELL_SIZE-10, CELL_SIZE-10))  # Điều chỉnh kích thước zombie phù hợp với ô
tile_image = pygame.image.load('tile2.png')  # Tải hình ảnh ô trống từ file PNG
...
gamerun_sound = pygame.mixer.Sound("gamerun.wav")
...
hammer_hit_image = pygame.image.load('hammer.png')
